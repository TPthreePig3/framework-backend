...
java -Dspring.datasource.url="jdbc:mysql://localhost:3306/threePig?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
 -Dspring.datasource.username=threePig \
 -Dspring.datasource.password=threePig \
